...
const addressData = [
  ...
  },
  {
    icon: faEnvelope,
    title: "My Email",
    description: "dev.suzanchandra@gmail.com",
  },
  {
    icon: faPhone,
    title: "Call Me Now",
    description: "+8801766510738",
  },
];
          ...
          <div>
            <div>
              ...
              <p className="text-[12px] xs:text-[14px] sm:text-lg md:text-lg max-lg:text-center pt-4 font-normal text-soft-dark">
                I’m available for freelance work and collaboration. If you have
                a project in mind, feel free to reach out — I’d love to help
