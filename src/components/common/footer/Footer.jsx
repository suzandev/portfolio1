    ...
    <div className="pt-25 md:pt-40 content max-2xl:px-3">
      <div className="flex max-md:flex-col justify-between mx-0 items-center h-full w-full text-neutral-200">
        <a href="#" className="flex items-center border-0">
          <img
            src={logo}
            className="h-8 sm:h-14 rounded-full bg-picto-primary"
            alt="logo"
          />
          <p className="text-3xl sm:text-[32px] my-auto ms-3 font-semibold">
            Suzan <span className="text-picto-primary">Chandra</span>
          </p>
        </a>
        ...
        <p className="text-[12px] sm:text-[16px]">
          Copyright &copy; {copyrightYear} Dev.
        </p>
      </div>
      <p className="text-white text-center max-xs:text-[12px] max-md:text-[14px] w-full py-10">
        Developed with ❤️ by{" "}
        <a href="#!" className="underline font-bold" target="_blank">
          Suzan Chandra
        </a>
      </p>
    </div>
